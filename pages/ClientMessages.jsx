...
import { MessageSquare, Send, AlertTriangle, Check, CheckCheck } from 'lucide-react';
...
export default function ClientMessages() {
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      await base44.entities.ChatMessage.create({
        ...
        sender_name: user.full_name || client.business_name,
        sender_type: 'client',
    ...
    return (
      <div className="flex flex-col items-center justify-center py-16">
        ...
        <p className="text-slate-500 text-center max-w-md">
          Contacta al administrador para poder comunicarte.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 h-[calc(100vh-180px)] flex flex-col">
      <PageHeader
        title="Mensajes"
        subtitle="Comunicación con tu contador"
      />

      <Card className="flex-1 border-slate-200/50 flex flex-col overflow-hidden">
        {/* Messages */}
